...
class BasicPage extends React.Component {
    constructor(props) {
        super(props);
        const user = utils.assign({}, props.config.user);
    ...
    render() {
        ...
        <div className="mod-3">
          <div className="art-mod">
            ...
            this.setState(this.state);
        }} type="text" className={cx('text input-xxl', { 'error': this.state.errors['userName'] })}/>
                    </span>
                    <span className="text-error" style={{ display: this.state.errors['userName'] ? '' : 'none' }}><i className="ico ico-err-2"/><em className="error-message">请设置姓名</em></span>
                  </li>
                  <li className="fm-item">
            ...
            client.users.edit({
                ...
                this.loading(false);
                if (!err) {
                    this.props.config.user.userName = res.userName;
                    this.props.config.user.gender = res.gender;
                    this.props.config.user.birthday = res.birthday;
                    this.props.config.user.signature = res.signature;
