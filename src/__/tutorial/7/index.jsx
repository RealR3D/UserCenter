            ...
            <div id="content-page">
                <div className="tpl-portlet-components">
                    <div className="portlet-title">
                        <div className="caption font-green bold">兴趣点环绕</div>
                    </div>
                    <div className="tpl-block ">
                        <div className="am-g tpl-amazeui-form">
                            <div className="am-u-sm-12 am-u-md-9">
                                <video src="https://3dvideodata.oss-cn-beijing.aliyuncs.com/video/7.mp4"  controls="controls" style={{width: "100%"}}>dasdasdasd</video>
                            </div>
                        </div>
                    </div>
                </div>
