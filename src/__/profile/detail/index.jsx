        ...
        <div className="mod-3">
          <div className="art-mod">
            ...
            client.users.edit({
                ...
                this.loading(false);
                if (!err) {
                    this.props.config.user.organization = res.organization;
                    this.props.config.user.department = res.department;
                    this.props.config.user.position = res.position;
                    this.props.config.user.education = res.education;
                    this.props.config.user.graduation = res.graduation;
                    this.props.config.user.address = res.address;
                    this.props.config.user.interests = res.interests;
